...
def createNPCList(scene): #add NPC's here. Additional features will be added later. 
    ...
    if scene == "town1":
        ...
        npcList.append(npc1)
        npc1 = npc("town1", 11, 9, "left", "sprites/emoSpriteSheet.png")
        npcList.append(npc1)
        npc1 = npc("town1", 12, 9, "left", "sprites/emoSpriteSheet.png")
        npcList.append(npc1)
        npc1 = npc("town1", 13, 9, "left", "sprites/emoSpriteSheet.png")
        npcList.append(npc1)
        npc1 = npc("town1", 14, 9, "left", "sprites/emoSpriteSheet.png")
        npcList.append(npc1)
        npc1 = npc("town1", 15, 9, "left", "sprites/emoSpriteSheet.png")
        npcList.append(npc1)
        npc1 = npc("town1", 16, 9, "left", "sprites/emoSpriteSheet.png")
        npcList.append(npc1)
        npc1 = npc("town1", 17, 9, "left", "sprites/emoSpriteSheet.png")
        npcList.append(npc1)
        npc1 = npc("town1", 18, 9, "left", "sprites/emoSpriteSheet.png")
        npcList.append(npc1)
        npc1 = npc("town1", 19, 9, "left", "sprites/emoSpriteSheet.png")
        npcList.append(npc1)
        npc1 = npc("town1", 20, 9, "left", "sprites/emoSpriteSheet.png")
        npcList.append(npc1)
